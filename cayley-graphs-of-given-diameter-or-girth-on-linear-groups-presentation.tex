...
%------------------------------------------------
% Pravdepodobne vynechat a existuje vela pristupov ako zvacsovat hranicu zhora alebo zdola
...
%------------------------------------------------
\begin{frame}
    % Pridat definiciu girth
    \frametitle{The degree/girth problem}
    \begin{definition}[Degree/girth problem]
...
\end{frame}
%------------------------------------------------
% Obidve casti su zlozite, snazil takze som sa zamerat na prvu cast. 
%------------------------------------------------
\begin{frame}
    \frametitle{Algorithm for checking girth}
	\lstinputlisting[language=Perl]{check_girth.pl}
\end{frame}
%------------------------------------------------
\begin{frame}
