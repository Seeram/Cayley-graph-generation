...
Same as for diameter we check girth of graph making computations on generating set. Checking if girth $g$ on graph we have to confirm that graphs doesn't have cycle with length $3 \leq n \leq g-1$.	
