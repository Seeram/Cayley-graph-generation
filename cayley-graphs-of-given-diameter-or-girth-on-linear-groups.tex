...
This bachelor thesis discuss two problems concerning construction of graphs with given parameters, namely {\em degree/diameter} and {\em degree/girth} problem. In our work we describe both problems, its theoretically possible bounds and some research results with focus on special case of Cayley graphs. We present algorithm for generating Cayley graph and exploitation of symmetry of Cayley graphs with computation of it's girth and diameter just on its symmeteric generating set. We also triedto find graphs as close to theoretical bound of both problems as possible and we list some of results in our randomized search in Special linear group.
