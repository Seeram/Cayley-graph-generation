...
\thispagestyle{empty}
{
     ...
     \normalsize
         \begin{tabular}[l]{p{0.27\textwidth}p{0.73\textwidth}}
			 ...
			 Ved\'uci diplomovej pr\'ace: & Jana \v{S}iagiov\'a \\
         \end{tabular}
     \vskip 3cm
...
%     \vspace{2cm}
%	 {\Large\itshape Matú\v{s} Behun, MPM\par}
%     \vfill
%	 Supervisor\par
%	 doc. RNDr. Jana \v{S}iagiová, PhD. 
%     \vfill
...
\subsection{Generation of cayley graphs with girth}
\lstinputlisting[language=Perl, frame=sinlge]{find_girth.pl}
