...
\thispagestyle{empty}
{
	...
	\vskip 0.2cm
	%\centerline{\Large \bf{Hï¿½ JEHO DRUHï¿½ RIADOK}}
	...
	\normalsize
		...
		ï¿½tudijny program: & Matematicko-pocï¿½tacovï¿½ modelovanie\\
		ï¿½tudijny odbor: & Aplikovanï¿½ matematika\\
		ï¿½koliace pracovisko: & dopln ma\\
		Vedï¿½ci diplomovej prï¿½ce: & dopln ma \\
		\end{tabular}
	\vskip 3cm
	\centerline{\large \bf{BRATISLAVA 2018}}
	\vskip 0.2cm
	\centerline{\large \bf{Matï¿½ï¿½ Behun}}
}
...
\begin{figure}[!ht]
	...
	\caption{ Output of ~\cite{Circos} of $C(SL(2,3), S)$, direction of edges is insignificant }
\end{figure}
