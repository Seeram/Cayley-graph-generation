...
%------------------------------------------------
\begin{frame}
	\frametitle{Construction of large graphs}

	Finding large graphs close to Moore bound is approached by many techniques in most cases by combinatorics on words algebraic structures. \\~\\ 
	
    Here we present two best bounds on large graphs: 
    \begin{equation*}
        n_{d,k} \geq \left( \frac{d}{2} \right)^{k} +  \left( \frac{d}{2} \right)^{k-1} \cite{Bas-Mil} 
    \end{equation*}
...
\begin{frame}
	...
	\end{definition} ~\\~\\
	Best lower bound on Cayley graphs obtained by \v{S}iagiov\'a and \v{S}ir\'a\v{n} \cite{Sia-Sir}: 
	\begin{theorem}
...
\begin{frame}
	...
	In our search we generated 150000 graphs for all listed degrees. \\~\\
